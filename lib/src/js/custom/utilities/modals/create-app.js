		...
		formSubmitButton.addEventListener('click', function (e) {
			...
			validator.validate().then(function (status) {
				...
				if (status == 'Valid') {
					...
					params += "members=" + teamMembers.join(",") + "&sign_ids=" + sign_ids.join(",");
					...
					// Now, 'params' contains all the query parameters you need
					console.log(params);
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            swal.fire({
                                text: "Thank you! You've created project successfully",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
